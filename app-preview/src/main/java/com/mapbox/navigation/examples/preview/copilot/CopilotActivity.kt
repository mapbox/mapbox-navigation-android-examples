...
class CopilotActivity : AppCompatActivity() {
    ...
    private fun buildTestRoute() {
        val origin = Point.fromLngLat(-77.0339911055176, 38.899920004207516)
        val destination = Point.fromLngLat(-77.03811675083008, 38.905113492482954)
