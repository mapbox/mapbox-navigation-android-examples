 ...
 * - You should now see trip progress information throughout the trip.
 *
 * Note:
...
class ShowTripProgressActivity : AppCompatActivity() {
    ...
    // Register the observer to listen to location feeds that is sent to to your [MapboxReplayer] to simulate the active route for you.
    ...
    private val binding: MapboxActivityTripProgressBinding by lazy {
        MapboxActivityTripProgressBinding.inflate(layoutInflater)
    }
