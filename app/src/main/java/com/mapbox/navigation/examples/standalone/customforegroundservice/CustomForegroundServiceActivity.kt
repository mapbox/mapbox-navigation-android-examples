package com.mapbox.navigation.examples.standalone.customforegroundservice
...
class CustomForegroundServiceActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.stop.setOnClickListener {
            ...
            stopService(Intent(this, CustomForegroundService::class.java))
        }
        ...
        binding.mapView.location.apply {
            ...
            this.locationPuck = LocationPuck2D(
                bearingImage = ContextCompat.getDrawable(
                    this@CustomForegroundServiceActivity,
...
class CustomForegroundService : Service(), LifecycleOwner {
